...
func (this *Uint64) HeaderSize() uint64 {
...
func (this *Uint64) Size() uint64 {
	return this.HeaderSize() +
		...
		common.IfThen(this.min != 0, uint64(8), 0) +
...
func (this *Uint64) StorageEncode(_ string) []byte {
	...
	if this.HasLimits() {
		v := []*big.Int{
			new(big.Int).SetUint64(this.value),
			new(big.Int).SetUint64(this.min),
			new(big.Int).SetUint64(this.max),
		}
