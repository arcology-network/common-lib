...
func NewUnboundedInt64() any {
	return NewBoundedInt64(math.MinInt64, math.MaxInt64)
}

func NewBoundedInt64(min, max int64) any {
	if min > max {
		return nil
	}
...
func (this *Int64) New(value, delta, _, min, max any) any {
	return &Int64{
