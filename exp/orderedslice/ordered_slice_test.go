...
func TestOrderedSlice(t *testing.T) {
	...
	set := NewOrderedSlice[string, int](10, nil, nil, func(str string) string { return str }, "1", "2", "5", "11", "12", "13")
	set.Append("15")
	...
	set = NewOrderedSlice(10, getter, greaterEqual, func(str string) string { return str }, "1", "2", "5", "11", "12", "13")
	set.Append("15")
