...
// 	if len(arr0) > 8192 {
// 		(*this) = Triplets[T0, T1, T2](slice.Append(arr0, func(i int, v T0) *Triplet[T0, T1, T2] {
...
// 	(*this) = Triplets[T0, T1, T2](slice.ParallelAppend(arr0, 8, func(i int, v T0) *Triplet[T0, T1, T2] {
// 		return &Triplet[T0, T1, T2]{
// 			First:  getter(i, &v),
// 			Second: arr1[i],
// 		}
