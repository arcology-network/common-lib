...
extern "C" {
	...
	void ripemd160(char* bytes, uint64_t* counts, uint64_t length, char* concatenatedHashes);
	void sha3256(char* bytes, uint64_t* counts, uint64_t length, char* concatenatedHashes);
