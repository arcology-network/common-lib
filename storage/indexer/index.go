...
func (this *Index[T]) Add(vals []T) {
	sortables := slice.Append(vals, func(_ int, v T) *sortable[T] { return newSortable[T](v, &this.compare) })
...
func (this *Index[T]) GreaterThan(lower T) []T {
	...
	return slice.Append(got, func(_ int, v btree.Item) T { return v.(*sortable[T]).v })
}
...
func (this *Index[T]) LessThan(upper T) []T {
	...
	return slice.Append(got, func(_ int, v btree.Item) T { return v.(*sortable[T]).v }) // Move the result to a slice.
}
