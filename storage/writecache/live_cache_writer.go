...
type LiveCacheWriter struct {
	*LiveCacheIndexer
	liveCache *CachedKVStore[string, crdtcommon.CRDT]
...
func NewLiveCacheWriter(cache *CachedKVStore[string, crdtcommon.CRDT], version int64, filter func(*statecell.StateCell) bool) *LiveCacheWriter {
